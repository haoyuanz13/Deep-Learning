...
'''
def processPlot():
  test_res_cls = np.load('res/RPN_test_cls.npy')
  test_res_reg = np.load('res/RPN_test_reg.npy')

  train_cls_loss = np.load('res/RPN_train_cls_loss.npy')
  train_cls_acc = np.load('res/RPN_train_cls_acc.npy')
  train_reg_loss = np.load('res/RPN_train_reg_loss.npy')
  train_reg_acc = np.load('res/RPN_train_reg_acc.npy')
