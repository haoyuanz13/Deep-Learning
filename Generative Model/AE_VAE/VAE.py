...
flags.DEFINE_integer("batch_size", 44, "The size of batch images [128]")
...
def VAE_main(dataset_train, dataset_test, cufs=True):
  ...
  scipy.misc.imsave(FLAGS.sampledir_cufs + '/original_input.png', test_ori)
  scipy.misc.imsave(FLAGS.sampledir_cufs + '/actual_input.png', test_input)
...
def main(cufs=True):
  ...
  if cufs:
    ...
    dataset_train = dataloader_celeba(3)
    dataset_test = dataloader_celeba(1)
